...
const AUDIO = {
    BEAR_LONG: new Audio('./music/bear-groan-long.mp3'),
    BEAR_SHORT: new Audio(
        './music/bear-groan-short.mp3'
    ),
    DOOR_OPEN: new Audio('./music/door-open.mp3'),
    DOOR_CLOSE: new Audio('./music/door-close.mp3'),
